...
""" pyJeedom v0.3
    ...
    Réglages → Système → Configuration / API : Accès API JSONRPC :
    Activé, IP Blanche, localhost
    Python 2 / Python 3
...
class jeedom():
    ...
    class _plugin:
        ...
        def listPlugin(self, activateOnly=False, orderByCaterogy=False):
            ...
            _params['params'] = {}
            if activateOnly:
                _params['params']['activateOnly'] = 1
            if orderByCaterogy:
                _params['params']['orderByCaterogy'] = 1
            return self.jeedom.callJeedom(_params)
        #
        ...
        def byId(self, id=None):
            ...
            return {"error": {"message":
                              "%s introuvable" % __class__.__name__}}
        #
        ...
        def deamonStart(self, plugin_id=None, debug=None, forceRestart=None):
            ...
            _params['params']['plugin_id'] = plugin_id
            if debug:
                _params['params']['debug'] = 1
            if forceRestart:
                _params['params']['forceRestart'] = 1
            return self.jeedom.callJeedom(_params)
        #
    ...
    class _eqLogic:
        ...
        def byHumanName(self, _humanName=''):
            ...
            for item in allEqlogics:
                object_name = (objectsList[item['object_id']]
                               if item['object_id'] is not None else 'Aucun')
        ...
        def byTypeAndId(self, eqType=None, id=None):
            ...
            _params['params'] = {}
            _params['params']['id'] = id
            _params['params']['eqType_name'] = eqType
            return self.jeedom.callJeedom(_params)
        #
    #
    ...
    class _cmd:
            ...
            for item in allCmds:
                ...
                for eq in allEqlogics:
                    if eq['id'] == item['eqLogic_id']:
                        ...
                        object_name = (objectsList[eq['object_id']]
                                       if eq['object_id'] is not None
                                       else 'Aucun')
                        break

                humanName = '[%s][%s][%s]' % (object_name,
                                              eqlogic_name, item['name'])
                if _humanName == humanName:
                    return item
            return {"error": {"message":
                              "%s introuvable" % __class__.__name__}}
        ...
        def event(self, id=None, value=None, datetime=None):
            ...
            _params['params']['value'] = value
            if datetime:
                _params['params']['datetime'] = datetime
            return self.jeedom.callJeedom(_params)
        #
    #
    ...
    class _scenario:
        ...
        def byHumanName(self, _humanName=''):
            ...
            for item in allScenarios:
                object_name = (objectsList[item['object_id']] if
                               item['object_id'] is not None else 'Aucun')
        ...
        def doImport(self, id=None, humanName=None, doImport=None):
            ...
            if humanName:
                _params['params']['humanName'] = humanName
            return self.jeedom.callJeedom(_params)
        #
    #
